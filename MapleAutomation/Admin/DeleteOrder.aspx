<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DeleteOrder.aspx.cs" Inherits="MapleAutomation.Admin.DeleteOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderAdmin" runat="server">
    ...
    <div class="container">
        <div class="row">
                <h3 class="text-primary">Delete Order</h3>
        ...
        <div class="row">
            ...
            <asp:GridView ID="GridView1" runat="server"
                AutoGenerateColumns="False" BackColor="White" Width="100%" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="OrderID" ForeColor="Black" GridLines="Horizontal" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting">
                <Columns>
