<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AutoSensor.aspx.cs" Inherits="MapleAutomation.ProductPage.AutoSensor" %>
    ...
    <div class="container">
        ...
        <div class="row">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#home" data-toggle="tab" aria-expanded="true">Auto Sensor</a></li>
            </ul>
              ...
              <div class="tab-pane fade active in" id="home">
                  <asp:DataList ID="DataList1" runat="server" DataKeyField="ProductID" DataSourceID="SqlDataSource1" Height="350px" RepeatColumns="4" RepeatDirection="Horizontal" Width="100%">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SQLCON %>" SelectCommand="SELECT * FROM [Product] WHERE ([CatagoryID] = @CatagoryID)">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="150" Name="CatagoryID" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
              </div>
            </div>
